...
| 24 Apr | Ed Bueler | hyperelasticity example from Patrick Farrell | [slides](slides/farrell24apr.pdf) <br> [poisson.py](py/bueler/poisson.py) <br> [hyperelasticity.py](py/bueler/hyperelasticity.py) <br> [repo](https://github.com/pefarrell/icerm2024/) |
